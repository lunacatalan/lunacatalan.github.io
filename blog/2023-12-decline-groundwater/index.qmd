...
citation: 
  url: https://lunacatalan.github.io/blog/2023-12-decline-groundwater/ 
draft: true
image: qazvin_preview.jpeg
toc: TRUE
---

# Problem

Groundwater supplies water resources for drinking water and irrigated agriculture for millions of people around the world. Groundwater levels are declining around the world. This is partly do to changing climatic trends, where declines in precipitation is leading to declines in recharge of groundwater storage in aquifers. Over the last couple of decades, agriculture production in many areas has also increased[@Gannett Satellite Information Network. (n.d.). Pumped Dry: The global crisis of vanishing groundwater. USA Today. https://www.usatoday.com/pages/interactives/groundwater/]. In arid regions, agriculture is mainly fed by groundwater since there is not enough surface water available, or it does not rain enough.

In the last 40 years, groundwater level declines in the Qazvin Plain of Iran have accelerated. Past research has indicated that agricultural production and population growth have contributed to over abstraction[@Babaee, S., Mousavi, Z., Masoumi, Z., Malekshah, A. H., Roostaei, M., & Aflaki, M. (2020). Land subsidence from interferometric SAR and groundwater patterns in the Qazvin plain, Iran. International Journal of Remote Sensing, 41(12), 4780-4798.]
...
![Table 1: Results of Multiple Linear Regression of Area Equipped for Irrigation and Precipitation on Groundwater Level Change](/blog/2023-12-decline-groundwater/images/mod_ir_precip.png){width=40%}

![Table 2: Results of Simple Linear Regression of Area Equipped on Irrigation on Groundwater Level Change](/blog/2023-12-decline-groundwater/images/mod_ir.png){width=40%}
...
![Figure 2: Buffer and Aquifer crop of Landsat satellite image](/blog/2023-12-decline-groundwater/images/buffer_aquifer.png){width=60%}
...
savi_plot <- ggplot(qazvin_clean, aes(x = year, y = change)) + 
  ...
  labs(x = "Year",
       y = "Change in Groundwater Level",
       color = "",
       caption = "Figure 3: Simple linear regression plot showing Median SAVI (index/pixel) and groundwater level change trend over time in the Qazvin plain.") +
  scale_y_continuous( "Average Change in Groundwater Level (m)", 
...
![Table 3: Results of Simple Linear Regression of median Soil Adjusted Vegetation Index (SAVI) on Irrigation on Groundwater Level Change](/blog/2023-12-decline-groundwater/images/mod_savi.png){width=40%}
...
This analysis showed that agricultural production (proxied by **area equipped for irrigation** and **soil adjusted vegetative index**) had a greater impact on groundwater level changes in the Qazvin Plain aquifer than precipitation.
